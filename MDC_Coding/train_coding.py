...
file_path = '/home/sjm/LFMPC_hxj/dataset/chess2/split_matrix/frame_1/'
#file1_path = sys.argv[2]
file1_path = '/home/sjm/LFMPC_hxj/chess2_out/P2/frame_1_out/'
...
# Select Description Pattern (Donwsampling Ratio)
Pattern = 2
...
# Create model
model = Reconstruction(numfrm, numfrm, numfrm).double()
...
for epoch in range(30000):
    ...
    torch.save(model, '/home/sjm/LFMPC_hxj/chess2_out/P2/LF-GNN.pt')
    if epoch_loss<temp:
        temp = epoch_loss
